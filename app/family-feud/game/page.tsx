...
export default function GamePage() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        // If this round's questions are already loaded (e.g. the display
        // was just refreshed, or the host is on the same round), keep the
        // in-progress reveals/index instead of wiping the board back to
        // question 1.
        const already =
  ...
  const handleEndOfRound = async () => {
    router.push("/family-feud/round-outro");
  };
