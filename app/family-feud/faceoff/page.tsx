...
import { fetchFaceoffQuestions } from "@/lib/family-feud/data";
import { bestMatch } from "@/lib/family-feud/fuzzy";
import { isTypingTarget } from "@/lib/shared/keyboard";

import * as a from "@/styles/shared/atoms.css";
import * as f from "@/styles/family-feud/faceoff.css";
import * as b from "@/styles/family-feud/board.css";
import { vars } from "@/styles/shared/theme.css";
import { sound } from "@/lib/shared/sounds";
import FaceoffSplash from "@/components/family-feud/FaceoffSplash";
...
export default function FaceoffPage() {
  ...
  // Spacebar shortcut to evaluate (ignored while typing a guess)
  useEffect(() => {
  ...
  // 🚀 Move to game board
  const goToBoard = () => router.push("/family-feud/game");
  // Winner theme color
  const teamAccent =
        ...
        <AnimatePresence mode="wait">
          <motion.div
            ...
            style={{
              ...
              zIndex: 50,
              padding: 16,
              // Only the buzz buttons inside should be clickable — without
              // this, this full-screen transparent layer silently blocks
              // clicks on anything behind it, including the 🎲 reroll button.
              pointerEvents: "none",
            }}
          >
