...
// Reusable UI — defined at module scope so identity is stable across
// re-renders (defining these inside the page component made React remount
// the underlying <input>/<select> — and drop focus — on every keystroke).
function Slot({
  value,
  onChange,
  accent,
        ...
        {step === "review" && (
          ...
          >
            <Shell>
              ...
              >
                <Link
                  href="/family-feud/team-generator"
                  target="_blank"
