...
import { playSound } from "@/lib/shared/sounds";
...
export default function FaceoffSplash({
  ...
  useEffect(() => {
    // Note: a value returned from inside the setTimeout callback below is
    // NOT a cleanup function — setTimeout ignores it. All timers must be
    // tracked here so the outer cleanup can actually clear them.
    ...
    >
      ...
      <AnimatePresence mode="wait">
        {showLogo && (
          ...
          >
            <Image
              src="/family-feud/ag1-ff-logo.png"
              alt="Family Feud AG1"
              width={400}
              height={400}
              style={{
